...
public class TGrafoNoDirigido extends TGrafoDirigido {
    ...
    public TGrafoNoDirigido(Collection<TVertice> vertices, Collection<TArista> aristas) {
        ...
        for (TArista a : aristas) {
            cont++;
            this.insertarAdyacenciaAlReves(a);
...
//        this.aristas.insertarAmbosSentidos(aristas);
    ...
    public boolean conectados(TVertice v, TVertice w) {
        if (v == null || w == null) {
            ...
            return v.conectados(w);
        }
    }

    public void insertarAdyacenciaAlReves(TArista a) {
        if ((a.getEtiquetaOrigen() != null) && (a.getEtiquetaDestino() != null)) {
            TVertice vertice1 = buscarVertice(a.getEtiquetaOrigen());
            TVertice vertice2 = buscarVertice(a.getEtiquetaDestino());
            if ((vertice1 != null) && (vertice2 != null)) {
                vertice2.insertarAdyacencia(a.getCosto(), vertice1);
            }
        }
    }
}
